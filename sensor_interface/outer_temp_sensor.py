...
class TempSensor(Node):
    def __init__(self):
        ...
        self.hygrometer_pub = self.create_publisher(Float32, 'outer_hygrometer', qos_profile)
        self.thermometer_pub = self.create_publisher(Float32, 'outer_thermometer', qos_profile)
